...
BOOL CPropertiesList::Create(CWnd *pParent)
{
//	WS_EX_CLIENTEDGE

	// Create the window
	CRect rect( 0, 0, 0, 0 );
//	if ( !CWnd::Create( NULL, "PropertiesList", WS_CHILD | WS_VISIBLE | WS_BORDER, rect, pParent, 0 ) )
//		return FALSE;

	if ( !CWnd::CreateEx( WS_EX_CLIENTEDGE, NULL, "PropertiesList",
						  WS_CHILD | WS_VISIBLE | WS_BORDER, rect,
						  pParent, 0 ) ) 
		return FALSE;
...
{	return FillCombo( (LPPROPINFO)wParam, (CComboBox*)lParam );
}
