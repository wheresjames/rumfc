...
class CPropertiesList : public C3DList, public CMessageList
{
// Construction
public:
	CPropertiesList();
...
public:
	...
	virtual BOOL FillCombo( LPPROPINFO pPi, CComboBox *pCombo )
	{	return FALSE; }
	...
	void SetIcon( DWORD dwIcon, HICON hIcon )
	{	m_editparam.SetIcon( dwIcon, hIcon ); }
